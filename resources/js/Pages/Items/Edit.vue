                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="w-full p-2">
                                                <div class="relative">
                                                    ...
                                                    <input v-model="form.price" type="number" id="price" name="price" class="w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200" />
                                                </div>
                                            </div>

                                            <div class="w-full p-2">
                                                <div class="relative">
                                                    <label for="is_selling" class="text-sm leading-7 text-gray-600">ステータス</label>
                                                    <input v-model="form.is_selling" value="1" type="radio" id="is_selling1" name="is_selling" />
                                                    <label class="ml-2 mr-4">販売中</label>
                                                    <input v-model="form.is_selling" value="0" type="radio" id="is_selling0" name="is_selling" />
