                        ...
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <div class="w-full mx-auto overflow-auto lg:w-2/3">
                                    <div class="flex w-full pl-4 mx-auto my-4 lg:w-full"></div>
                                    <table class="w-full text-left whitespace-no-wrap table-auto">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="px-4 py-3 text-sm font-medium tracking-wider text-gray-900 bg-gray-100 title-font">合計金額</th>
                                                <th class="px-4 py-3 text-sm font-medium tracking-wider text-gray-900 bg-gray-100 title-font">ステータス</th>
                                                <th class="px-4 py-3 text-sm font-medium tracking-wider text-gray-900 bg-gray-100 title-font">購入日</th>
                                            </tr>
                                        </thead>
                                        <tbody>
